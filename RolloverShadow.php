		...
		case 'courses':
         $rollover_shadow_course= "";
			...
			foreach($get_cp_dt as $arr_ind=>$arr_dt)
                        {
                            $arr_dt['TITLE']= html_entity_decode($arr_dt['TITLE']);
                            $arr_dt['SHORT_NAME']= html_entity_decode($arr_dt['SHORT_NAME']);
