...
function _makeExtraAssnCols($assignment_id, $column)
{
    ...
    switch ($column) {
        ...
        case 'LETTER_GRADE':
            ...
            break;
        case 'COMMENT':
            return TextInput($current_RET[$THIS_RET['STUDENT_ID']][$assignment_id][1]['COMMENT'], 'values[' . $THIS_RET['STUDENT_ID'] . '][' . $assignment_id . '][COMMENT]', '', '  size=11 maxlength=400 tabindex=' . (500 + $tabindex));
            break;
    }
}
...
function _makeExtraStuCols($value, $column)
{
    ...
    switch ($column) {
        ...
        case 'COMMENT':
            ...
            return TextInput($value, 'values[' . $THIS_RET['STUDENT_ID'] . '][' . $THIS_RET['ASSIGNMENT_ID'] . '][COMMENT]', '', ' size=11 maxlength=400 tabindex=' . $tabindex);
            break;
    }
}
