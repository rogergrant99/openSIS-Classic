...
{	                        
                        ...
                        if(!$_REQUEST['new_school'] && count($sch_img_info)>0){
                            $image="<img src='data:image/jpeg;base64,".base64_encode($sch_img_info[1]['CONTENT'])."' width='80' style='float: left;' class='m-r-15 img-responsive' alt='Logo'/>";
...
//                        if($logo_ret && file_exists($logo_ret[1]['VALUE'])){
                            ...
                            $width=$size[0];
                            $height=$size[1];
                            $image='<img src="data:image/jpeg;base64,'.base64_encode($sch_img_info[1]['CONTENT']).'" width="80" style="float: left;" class="m-r-15" alt="Logo" />';
                        }
                         else {
                             $image= '<img src="assets/logo.png" width="60" style="float: left;" class="m-r-15" alt="Logo" />';
                        }
